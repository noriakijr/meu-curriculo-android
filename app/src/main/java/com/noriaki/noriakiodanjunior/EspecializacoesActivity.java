...
public class EspecializacoesActivity extends ActionBarActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_especializacoes, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_sobre:
                AlertDialog.Builder builder = new AlertDialog.Builder(EspecializacoesActivity.this);
